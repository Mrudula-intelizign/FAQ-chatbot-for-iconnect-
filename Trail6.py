...
# Build dataset with plain + metadata enriched examples
for item in faq_data:
    intent = item["intent"]
    meta = item.get("metadata", {})
    meta_str = build_meta_str(meta)
